...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/12 12:24:36 by fmustin           #+#    #+#             */
/*   Updated: 2022/10/12 12:24:37 by fmustin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ray_calc_tex_pos(t_data *data)
{
	if (data->ray.side == 0)
	{
		data->tex.wall_x = data->ray.ray_pos_y + data->ray.wall_dist
			* data->ray.ray_dir_y;
	}
	else
	{
		data->tex.wall_x = data->ray.ray_pos_x + data->ray.wall_dist
			* data->ray.ray_dir_x;
	}
